...
?>
	 ...
	 <tbody>
        <tr class="gradeC">
			...
			<td><a href="user_delete.php?del=<?php echo $id;?>"><button type="button" class="btn btn-success"><span class="fa fa-trash-o">&nbsp;</span>Delete</button></a></td>
		</tr>
 </tbody>
